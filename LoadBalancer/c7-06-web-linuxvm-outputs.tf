...
output "web_linuxvm_nic_1_id" {
  description = "Web Linux VM Network Interface ID"
  value       = azurerm_network_interface.web_linuxvm_nic_1.id
}

## Networl Interface Private IP Address
output "web_linuxvm_nic_1_private_ip" {
  description = "Web Linux VM Network Interface Private IP Address"
  value       = azurerm_network_interface.web_linuxvm_nic_1.private_ip_address
}
...
output "web_linuxvm_virtual_machine_id_128bits" {
  ...
  value       = azurerm_linux_virtual_machine.web_linuxvm_1.virtual_machine_id
}

## Virtual Machine ID
output "web_linuxvm_virtual_machine_id" {
  description = "Web Linux VM ID"
  value       = azurerm_linux_virtual_machine.web_linuxvm_1.id
}
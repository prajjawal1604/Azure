...
#     sudo echo "Hello World from CentralUs" > /var/www/html/index.html
...
resource "azurerm_linux_virtual_machine_scale_set" "web_vmss" {
  ...
  network_interface {
    ...
    ip_configuration {
      ...
      application_gateway_backend_address_pool_ids = [one(azurerm_application_gateway.web_ag.backend_address_pool).id]
    }
  }
